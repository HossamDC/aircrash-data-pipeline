...
# Load CSV from S3 (with s3:// prefix in Spark)
...
# Final columns
df_final = df.select(
    "Crash_Date", "Year", "Month", "Location", "Operator", "Type",
...
print("✅ ETL Complete: Parquet written to S3.")
